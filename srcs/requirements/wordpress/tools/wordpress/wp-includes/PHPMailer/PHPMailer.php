...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@sel-fcht.42.fr';
...
//            $result .= static::$LE;
     ...
     * Returns 'sel-fcht.42.fr.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return 'sel-fcht.42.fr.localdomain';
        }
