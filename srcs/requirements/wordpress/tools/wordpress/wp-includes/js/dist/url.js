 ...
 * const authority2 = getAuthority( 'https://sel-fcht.42.fr:8080/test/' ); // 'sel-fcht.42.fr:8080'
 * ```
 *
 ...
 * @example
 * ```js
 * const path1 = getPath( 'http://sel-fcht.42.fr:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
 ...
 * @example
 * ```js
 * const queryString = getQueryString( 'http://sel-fcht.42.fr:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
 * ```
 *
 ...
 * @example
 * ```js
 * const pathAndQueryString1 = getPathAndQueryString( 'http://sel-fcht.42.fr:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
 ...
 * @example
 * ```js
 * const fragment1 = getFragment( 'http://sel-fcht.42.fr:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
