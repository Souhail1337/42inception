...
class WP_Http {
	 ...
	 * file and this will only allow sel-fcht.42.fr and your site to make requests. The constant
	...
	public function block_request( $uri ) {
		...
		if ( 'sel-fcht.42.fr' === $check['host'] || ( isset( $home['host'] ) && $home['host'] == $check['host'] ) ) {
			 ...
			 *
			 * A local request is one to `sel-fcht.42.fr` or to the same host as the site itself.
			 *
			 * @since 2.8.0
			 *
